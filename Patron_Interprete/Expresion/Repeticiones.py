...
from Patron_Interprete.Tabla_Simbolos.Tipos import RetornoType,tipo
from Patron_Interprete.Expresion.Arreglo import ArregloData
from Patron_Interprete.Tabla_Simbolos.InstanciaArreglo import InstanciaArreglo
