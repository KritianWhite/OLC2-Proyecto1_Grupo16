...
from Patron_Interprete.Expresion import Declaracion
...
class AST(Intruccion):
    ...
    def Ejecutar3D(self, controlador, ts):
        ...
        #try:
            for intruccion in self.Lista_instrucciones:
                if isinstance(intruccion, Declaracion):
                    structt = intruccion
    ...
    def reporte_solo(self,actual):
            ...
            for x in actual.tabla:
                ...
                if isinstance(recorido, RetornoType):
                    if isinstance(recorido.valor, Declaracion):
                        TipoSimbolo = "Declaracion"
    ...
    def Exportar_TablaErrores(self, Reporte):
        ...
        file_path = Path(r"C:\Users\kriti\OneDrive\Escritorio\hola_Diosito\OLC2_P2_202000119-main\Reportes\TablaErrores.HTML")
    ...
    def Exportar_TablaSimbolos(self,Reporte):
        ...
        ReporteFinal = htmlInicial + Reporte + htmlFinal
        file_path = Path(r"C:\Users\kriti\OneDrive\Escritorio\hola_Diosito\OLC2_P2_202000119-main\Reportes\TablaSimbolos.HTML")
        FileHTML = open(file_path, "w")
        FileHTML.write(ReporteFinal)
        FileHTML.close()
